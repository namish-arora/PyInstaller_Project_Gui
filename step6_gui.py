...
app_name_entry = tk.Entry(root, width=40,bd=2, font=("Arial", 10))
...
preview_text = tk.Text(root, height=10, width=40, wrap="none",bd=2, font=("Arial", 10))
...
#step 5: Adding a button to run PyInstaller and then step6 to actually convert  to .exe
import subprocess
...
#     if file_path:
#         data_file_entry.insert(tk.END, file_path + ";.")

# data_file_label = tk.Label(root, text="Add Data File:")
# data_file_label.pack(anchor="w", padx=20)
# data_file_entry = tk.Entry(root, width=50)
# data_file_entry.pack(padx=20)
# data_file_button = tk.Button(root, text="Browse", command=browse_data_file)
# data_file_button.pack(padx=20, pady=5)




package_button = tk.Button(root, text="Package App",width=20, command=run_pyinstaller, bg="green", fg="white", font=("Arial", 12))
