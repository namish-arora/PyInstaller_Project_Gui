...
def wrapper_function():
    ...
    if output_label is None:
        output_frame.pack(before= package_button,anchor=tk.W, padx=20, pady=(10, 0))  # Show output frame
        output_label = tk.Label(output_frame, text="Output:", font=("Arial", 12))
        output_label.pack(side=tk.LEFT, padx=(0, 10))  # Add some space between label and text area
        ...
        scrollbar.pack(side=tk.BOTTOM, fill=tk.X)  # Add scrollbar to the output text
